...
module Minitest
  ...
  module Assertions
    ...
    def refute_includes collection, sub, msg = nil
      msg = message(msg) { "Expected #{mu_pp collection} to not include #{mu_pp sub}" }
      refute_operator collection, :include?, sub, msg
    end
